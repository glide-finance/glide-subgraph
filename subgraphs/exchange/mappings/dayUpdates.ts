...
export function updateTokenDayData(token: Token, event: ethereum.Event): TokenDayData {
  ...
  if (tokenDayData === null) {
    ...
    tokenDayData.priceUSD = token.derivedELA.times(bundle.elaPrice);
    tokenDayData.dailyVolumeToken = ZERO_BD;
    tokenDayData.dailyVolumeELA = ZERO_BD;
  ...
  tokenDayData.totalLiquidityELA = token.totalLiquidity.times(token.derivedELA as BigDecimal);
  tokenDayData.totalLiquidityUSD = tokenDayData.totalLiquidityELA.times(bundle.elaPrice);
